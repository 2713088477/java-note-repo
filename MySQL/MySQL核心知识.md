...
<font style="color:#DF2A3F;">where与having的区别：</font>

<font style="color:#DF2A3F;">1.执行时机不同:where在分组之前筛选,having在分组之后筛选</font>

<font style="color:#DF2A3F;">2.判断条件不同:having中可以用聚合条件，而where中不可以</font>
...
| substring(str,start,len)        | 截取str,start开始的len个字符(<font style="color:#DF2A3F;">下标从1开始</font>) |
